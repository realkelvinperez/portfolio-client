...
export default function Quote() {
  let quote: MyRef = useRef(null);
  let quoteUp: MyRef = useRef(null);
  let quoteDown: MyRef = useRef(null);
  let quoteText: MyRef = useRef(null);
  let quoteAuthor: MyRef = useRef(null);
    ...
    <QuoteSection ref={(el) => (quote = el)}>
      <QuoteWrapper>
        ...
        <QuoteText ref={(el) => (quoteText = el)}>
          Design is not just what it looks like & feels like. Design is how it{" "}
          <QuoteHighlighted>Works!</QuoteHighlighted>
        </QuoteText>
