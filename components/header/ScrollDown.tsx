...
export default function ScrollDown() {
  ...
  return (
    <ScrollDownWrap>
      <ScrollDownText ref={(el) => (scrollText = el)}>Scroll</ScrollDownText>
      <ScrollDownIcon>
        <ScrollDownSVG
          ref={(el) => (scroll = el)}
          width="40"
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenOdd"
            d="M0 19.5591C0 8.7569 8.95431 0 20 0C31.0457 0 40 8.75691 40 19.5591V65.4409C40 76.2431 31.0457 85 20 85C8.95431 85 0 76.2431 0 65.4409V19.5591ZM20 3.00909C10.6536 3.00909 3.07692 10.4188 3.07692 19.5591V65.4409C3.07692 74.5812 10.6536 81.9909 20 81.9909C29.3464 81.9909 36.9231 74.5812 36.9231 65.4409V19.5591C36.9231 10.4188 29.3464 3.00909 20 3.00909Z"
            fill="url(#paint0_linear)"
          />
          <rect
            ref={(el) => (scrollBall = el)}
            className="scroll-down-ball"
            x="10.5"
            y="9.46326"
            width="20"
            height="20"
      ...
      <ScrollDownText ref={(el) => (downText = el)}>Down</ScrollDownText>
    </ScrollDownWrap>
  );
}
